...
EOD;
    ...
    public static function navbar($content, $htmlOptions = array())
    {
        ...
        $tag = TbArray::popValue('tag', $htmlOptions, 'nav');
        self::addCssClass('container-fluid', $innerOptions);
    ...
    {
        self::addCssClass('navbar-toggle collapsed', $htmlOptions);
